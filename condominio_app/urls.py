...
urlpatterns = [
    ...
    # Vistas de administrador (administrador = inicio; administrar = resto; duplicamos bajo administrador para evitar 404)
    ...
    path('home/administrador/bancos/', views.admin_bancos, name="admin_bancos"),
    path('home/administrador/gastos/', views.admin_gastos, name="admin_gastos"),
    path('home/administrador/ingresos/', views.admin_ingresos, name="admin_ingresos"),
    path('home/administrador/deudas/', views.admin_deudas, name="admin_deudas"),
    path('home/administrador/deudas/caja/', views.admin_deudas_caja, name="admin_deudas_caja"),
    path('home/administrador/deudas/abonar/<int:id>', views.admin_abono_deudas, name="admin_abono_deudas"),
    path('home/administrador/fondos/', views.admin_fondos, name="admin_fondos"),
    path('home/administrador/propietarios/', views.admin_propietarios, name="admin_propietarios"),
    path('home/administrador/propietarios/movimiento/', views.admin_propietarios_mov, name="admin_propietarios_mov"),
    path('home/administrador/validacion-pagos/', views.admin_validacion_pagos, name="admin_validacion_pagos"),
    path('home/administrador/torres/', views.admin_torres, name="admin_torres"),
    path('home/administrador/noticias/', views.admin_noticias, name="admin_noticias"),
    path('home/administrador/cuentas/', views.admin_cuentas, name="admin_cuentas"),
    path('home/administrador/reportes/', views.admin_reportes, name="admin_reportes"),
    path('home/administrador/cierres/', views.admin_cierres, name="admin_cierres"),
    path('home/administrador/cierres/precierre/', views.precierre, name="precierre"),
    path('home/administrador/configuracion/<str:type>', views.admin_configuracion, name="admin_configuracion"),
    path('home/administrador/configuracion/domicilios/', views.admin_domicilios, name="admin_domicilios"),
    path('home/administrador/configuracion/recargos-y-descuentos/', views.configuracion_recargos_descuentos, name="configurar_recargos_y_descuentos_alt"),
    path('home/administrador/configuracion/tasas-de-cambio/', views.configuracion_tasas_de_cambio, name="tasas_de_cambio_alt"),
    path('home/administrador/configuracion/establecer-precios/', views.configuracion_establecimiento_precios, name="establecimiento_precios_alt"),
    path('home/administrador/bancos/ver/<int:id>', views.readBancos, name="readBancos_alt"),
    path('home/administrador/gastos/ver/<int:id>', views.readGastos, name="readGastos_alt"),
    path('home/administrador/ingresos/ver/<int:id>', views.readIngresos, name="readIngresos_alt"),
    path('home/administrador/pagos/ver/<int:id>', views.readPagoMovimiento, name="readPagoMovimiento_alt"),
    path('home/administrador/deudas/ver/<int:id>', views.readDeudas, name="readDeudas_alt"),
    path('home/administrador/deudas/ver/propietario/<int:id>/<id_propietario>', views.readPropDeudas, name="readPropDeudas_alt"),
    path('home/administrador/propietarios/ver/<int:id>', views.readPropietarios, name="readPropietarios_alt"),
    path('home/administrador/cuentas/ver/<int:id>', views.readCuentas, name="readCuentas_alt"),
    path('home/administrador/bancos/actualizar/<int:id>', views.updateBancos, name="updateBancos_alt"),
    path('home/administrador/gastos/actualizar/<int:id>', views.updateGastos, name="updateGastos_alt"),
    path('home/administrador/ingresos/actualizar/<int:id>', views.updateIngresos, name="updateIngresos_alt"),
    path('home/administrador/deudas/actualizar/<int:pk>', views.DeudasUpdateView.as_view(), name="updateDeudas_alt"),
    path('home/administrador/propietarios/actualizar/<int:id>', views.updatePropietarios, name="updatePropietarios_alt"),
    path('home/administrador/cuentas/actualizar/<int:id>', views.updateCuentas, name="updateCuentas_alt"),
    path('home/administrador/noticias/actualizar/<slug>', views.updateNoticia, name="updateNoticia_alt"),
    path('home/administrador/torres/actualizar/<int:id>', views.updateTorres, name="updateTorres_alt"),
    path('home/administrador/domicilio/actualizar/<id_domicilio>', views.updateDom, name="updateDom_alt"),
    path('home/administrador/bancos/eliminar/<int:id>', views.destroyBancos, name="destroyBancos_alt"),
    path('home/administrador/gastos/eliminar/<int:id>', views.destroyGastos, name="destroyGastos_alt"),
    path('home/administrador/ingresos/eliminar/<int:id>', views.destroyIngresos, name="destroyIngresos_alt"),
    path('home/administrador/deudas/eliminar/<int:id>', views.destroyDeudas, name="destroyDeudas_alt"),
    path('home/administrador/propietarios/eliminar/<int:id>', views.destroyPropietarios, name="destroyPropietarios_alt"),
    path('home/administrador/cuentas/eliminar/<int:id>', views.destroyCuenta, name="destroyCuentas_alt"),
    path('home/administrador/noticia/eliminar/<slug>', views.destroyNoticia, name="destroyNoticia_alt"),
    path('home/administrador/torres/eliminar/<int:id>', views.destroyTorres, name="destroyTorres_alt"),
    path('home/administrador/domicilio/eliminar/<int:id>', views.destroyDom, name="destroyDom_alt"),
    path('home/administrador/gastos/ver/referencia', views.downloadReferencia, name="downloadReferencia_alt"),
    path('home/administrador/gastos/ver/referenciaI', views.downloadReferenciaingreso, name="downloadReferenciaingreso_alt"),
    path('home/administrador/propietarios/enviar_email/<int:id>', views.enviar_email, name="enviar_email_alt"),
    ...
    path('home/administrar/deudas/caja', views.admin_deudas_caja, name="admin_deudas_caja_no_slash"),
    path('home/administrar/deudas/caja/', views.admin_deudas_caja, name="admin_deudas_caja"),
